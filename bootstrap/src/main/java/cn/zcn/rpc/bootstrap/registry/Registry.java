 ...
 * {@code release()}。只有当所有服务提供者和服务消费者都释放 {@code Registry} 的实例时，{@code Registry} 才可以被关闭。
 * </pre>
 *
 * @author zicung
 */
...
public abstract class Registry extends AbstractLifecycle {
     ...
     */
    public abstract void register(ProviderConfig providerConfig, Collection<ProviderInterfaceConfig> providerInterfaceConfigs) throws RegistryException;
     ...
     * @throws RegistryException 失败异常
     */
    public abstract void unregister(Collection<ProviderInterfaceConfig> providerInterfaceConfigs) throws RegistryException;
